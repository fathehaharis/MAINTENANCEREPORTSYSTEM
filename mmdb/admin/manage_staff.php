    ...
    <div class="container">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <a href="edit_staff.php?id=<?= $row['user_id'] ?>" class="action-btn edit">Edit</a>
                    <a href="delete_staff.php?id=<?= $row['user_id'] ?>" class="action-btn delete" onclick="return confirm('Are you sure you want to delete this staff?');">Delete</a>
                </td>
            </tr>
            <?php endwhile; ?>
            <?php if ($result->num_rows == 0): ?>
            <tr><td colspan="5" style="text-align:center;color:#888;">No staff found.</td></tr>
            <?php endif; ?>
        </table>
    </div>
</div>
